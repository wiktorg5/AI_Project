...
def park_save(filename, param):
    ...
    pli.write("place_width = " + str(param.place_width) + "\n")
    pli.write("park_depth = " + str(param.park_depth) + "\n")
    pli.write("street_width = " + str(param.street_width) + "\n")
    pli.write("street_length = " + str(param.street_length) + "\n")
    pli.write("car_width = " + str(param.car_width) + "\n")
    pli.write("car_length = " + str(param.car_length) + "\n")
    pli.write("front_axis_dist = " + str(param.front_axis_dist) + "\n")
    pli.write("back_axis_dist = " + str(param.back_axis_dist) + "\n")
